...
- The edx-platform `development requirements <https://github.com/openedx/edx-platform/blob/open-release/teak.master/requirements/edx/development.in>`__ are installed.
